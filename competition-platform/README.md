...
| 🪄 小智 AI 辅助训练 | 训练中心本地 DeepSeek R1 流式问答，支持知识讲解、代码分析、训练计划、练习出题及资源上下文 |
...
- 小智连接宿主机 Ollama，请先执行 `ollama pull deepseek-r1:7b` 并保持 Ollama 运行
...
| 🪄 小智 AI 辅助训练 | ✅ 登录后多轮问答、SSE 流式输出、训练场景上下文、停止生成、本地历史、限流及 Ollama 离线提示 |
